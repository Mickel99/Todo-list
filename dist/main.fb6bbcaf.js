...
var Todo = /*#__PURE__*/_createClass(function Todo(name, completed) {
...
function addTodo(event) {
  ...
  var task = new _todo.Todo(todoInput.value, false);
  if (todoInput.value === "") {
...
function saveToLocal() {
  var theList = JSON.stringify(todos);
  localStorage.setItem("todos", theList);
}
window.addEventListener("load", function () {
  todos = JSON.parse(localStorage.getItem("todos")).map(function (todoItem) {
    return new _todo.Todo(todoItem.name, todoItem.completed);
  });
  createHtml();
});
},{"./todo":"js/todo.js"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
